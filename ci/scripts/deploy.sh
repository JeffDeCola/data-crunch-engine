...
echo "STEP 1 - Build a custom image using packer"
echo "Your boot disk that contains all your stuff (the data-crunch-engine docker image)"

echo "cd data-crunch-engine/example-01/deploy-gce/build-image"
cd data-crunch-engine/example-01/deploy-gce/build-image
echo " "
