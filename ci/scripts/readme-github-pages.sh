#!/bin/sh
# data-crunch-engine readme-github-pages.sh
...
echo "The goal is to git clone /data-crunch-engine to /data-crunch-engine-updated"
...
echo "   /data-crunch-engine-updated (created in task-build-push.yml task file)"
echo " "
...
echo "git clone data-crunch-engine to data-crunch-engine-updated"
git clone data-crunch-engine data-crunch-engine-updated
echo " "

echo "cd data-crunch-engine-updated"
cd data-crunch-engine-updated
echo " "
...
echo "    sed -i 's/svgs\//https:\/\/raw.githubusercontent.com\/JeffDeCola\/data-crunch-engine\/master\/svgs\//g' temp-README.md"
sed -i 's/svgs\//https:\/\/raw.githubusercontent.com\/JeffDeCola\/data-crunch-engine\/master\/svgs\//g' temp-README.md
echo " "
