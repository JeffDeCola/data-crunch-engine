...
echo "cp -r data-crunch-engine/data-crunch-engine-code/* dist"
cp -r data-crunch-engine/data-crunch-engine-code/* dist
echo " "
...
#cp "$GOPATH/src/github.com/JeffDeCola/data-crunch-engine/data-crunch-engine-code/bin/hello-go" .
#echo " "

#echo "cp the Dockerfile into /dist"
#cp "$GOPATH/src/github.com/JeffDeCola/data-crunch-engine/data-crunch-engine-code/build-push/Dockerfile" .
#echo " "
