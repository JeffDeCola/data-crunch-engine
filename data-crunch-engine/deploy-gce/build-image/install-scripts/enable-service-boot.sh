#!/bin/bash -e
# data-crunch-engine enable-service-boot.sh
...
cp /root/src/github.com/JeffDeCola/data-crunch-engine/data-crunch-engine/deploy-gce/build-image/hello-go.service /lib/systemd/system/.
echo " "
